...
import { Snowflake, Permissions, Message, Collection, PermissionResolvable, DMChannel, CategoryChannel, NewsChannel, ThreadChannel, TextChannel, StageChannel, VoiceChannel, GuildMember, Role, User, ClientOptions, ClientEvents, Client, Guild, PartialDMChannel } from 'discord.js';
 ...
 * @typeparam E The error's type.
 */
declare function from<T, E = Error>(cb: (...args: unknown[]) => T): Result<T, E>;
/**
 * Creates a {@link Result} out of a promise or async callback.
 * @typeparam T The result's type.
 * @typeparam E The error's type.
 */
declare function fromAsync<T, E = Error>(promiseOrCb: Awaited<T> | ((...args: unknown[]) => Awaited<T>)): Promise<Result<T, E>>;
